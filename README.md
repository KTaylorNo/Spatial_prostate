...
A spatial transcripomtic dataset consisting of 37 tissue sections from two patients with localised high-grade disease (previously generated by Erickson et al. using the Visium Spatial Platform) was downloaded from the European Genome-phenome Archive. This GitHub repository contains code documenting data pre-processing steps and downstream analyses to explore biomarker spatial gene expression patterns and tissue type associations.
